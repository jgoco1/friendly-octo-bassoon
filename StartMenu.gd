...
var ship_types = ["Interceptor", "Pi_Fighter"]  # List of available ship types
...
func update_ship_display():
	...
	ship_title.text = selected_type  # Show name
	ship_description.text = GameManager.player_types[selected_type]["description"]  # Get description
